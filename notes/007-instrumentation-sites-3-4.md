...
3. **Telemetry hot-path latency constraint**
   ...
   Mario: I take non blocking to mean anything can happen off the imperative execution
   path, just dont hold the main path up. io or compute can still happen in asynchronously
   through the native schedule ( whatever processes futures ) 
